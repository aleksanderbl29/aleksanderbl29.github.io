...
## R og statistisk programmering

Jeg har meget erfaring i R med analytiske pipelines og reproducerbare analyser. Her har jeg brugt `targets` sammen med eksempelvis `tidymodels`.

## R-pakker

Jeg vedligeholder et par `R`-pakker. En af disse har fundet sin vej til [CRAN](https://cran.r-project.org/). Du kan finde en oversigt på siden [r-pakker](/rpkg.html).
