...
- Jeg arbejder på at få denne output-stil integreret i den primære downloadside, men det kræver at CSL-projektet vil acceptere den. Du kan læse mere om, hvad det kræver [her](https://github.com/citation-style-language/styles/blob/master/README.md#criteria-for-inclusion). Du kan også følge med i processen [her](https://github.com/citation-style-language/styles/pull/6797).
